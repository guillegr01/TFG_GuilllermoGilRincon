...
import { postTherapyController, getTherapyByUserController, putTherapyByIdController } from "../controllers/therapyControllers";
...
router.put("/:id", putTherapyByIdController);